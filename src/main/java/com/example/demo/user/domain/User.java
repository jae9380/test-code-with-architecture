...
import com.example.demo.commone.infrastructure.SystemClockHolder;
...
public class User {
    ...
    public User certificate(String certificationCode) {
        if (!this.certificationCode.equals(certificationCode)) throw new CertificationCodeNotMatchedException();
        return User.builder()
                .id(id)
                .email(email)
                .nickname(nickname)
